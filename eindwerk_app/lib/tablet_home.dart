...
class Mytablethome extends StatefulWidget {
  //de homepagina class
  @override
  _MytablethomeState createState() => _MytablethomeState(); //creërt de pagina
}

class _MytablethomeState extends State<Mytablethome> {
  //de pagina zelf
  void click() {
